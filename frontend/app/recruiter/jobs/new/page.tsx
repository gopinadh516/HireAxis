...
export default function RecruiterNewJobPage() {
  ...
  async function handleSubmit(data: JobFormData) {
    ...
    try {
      ...
      await apiFetch<{ id: string }>("/api/jobs/", { method: "POST", body: JSON.stringify(payload) });
      toast.success("Job posted — pending approval");
  ...
  return (
    <>
      <Shell role="recruiter" pageTitle="Post a Job" pageSubtitle="Fill in the details below">
        <div className="mb-4">
        ...
        <div className="max-w-3xl">
          <JobForm mode="internal" onSubmit={handleSubmit} submitting={submitting} />
        </div>
      </Shell>
