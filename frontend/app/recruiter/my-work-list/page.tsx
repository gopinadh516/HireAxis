...
export default function RecruiterMyWorkListPage() {
  ...
  return (
    <>
      <Shell role="recruiter" pageTitle="My Work List" pageSubtitle="Cases assigned to you">
        <div className="mb-4">
        ...
        <div className="space-y-2">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border py-16">
              ...
              <p className="mt-1 text-xs text-muted-foreground/60">Cases assigned to you will appear here</p>
            </div>
          ) : (
            filtered.map((a) => (
              <WorkListCard key={a.id} assignment={a} role="recruiter" />
            ))
          )}
        </div>
      </Shell>
