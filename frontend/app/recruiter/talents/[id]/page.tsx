        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <Link href={`/recruiter/talents/${id}/edit`}>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {aiSummary.technical_skills.primary?.length > 0 && (
                          <div>
                            <span className="text-[10px] font-medium text-muted-foreground mr-2">Primary</span>
                        ...
                        {aiSummary.technical_skills.secondary?.length > 0 && (
                          <div>
                            <span className="text-[10px] font-medium text-muted-foreground mr-2">Secondary</span>
                            <div className="mt-1 flex flex-wrap gap-1">
                        ...
                        {aiSummary.technical_skills.tools_platforms?.length > 0 && (
                          <div>
                            <span className="text-[10px] font-medium text-muted-foreground mr-2">Tools & Platforms</span>
                            <div className="mt-1 flex flex-wrap gap-1">
                              {aiSummary.technical_skills.tools_platforms.map((s, i) => (
                                <span key={i} className="rounded-full bg-violet-50 border border-violet-200 px-2.5 py-0.5 text-[11px] text-violet-700">{s}</span>
                              ))}
                            </div>
                          </div>
                        )}
